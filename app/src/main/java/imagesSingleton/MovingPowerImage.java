...
public class MovingPowerImage {

    private static MovingPowerImage instance;
    ...
    private MovingPowerImage(Bitmap originalImage, int rowCount, int colCount) {
    ...
    public static MovingPowerImage getInstance(Bitmap image, int rowCount, int colCount) {
        if (instance == null) {
            instance = new MovingPowerImage(image, rowCount, colCount);
        }
        return instance;
    }
